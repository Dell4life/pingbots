...
function generateEmbed(color, title, authorName, authorLink, authorImg, description, footerText, footerImg) {
    ...
    var generatedEmbed = new Discord.MessageEmbed()
		.setColor(color)
		.setTitle(title)
		.setAuthor(message.author.username, message.author.Img, message.author.Link)
...
client.on('message', message => {
	...
	//Error while creating embed
		...
		var pingMsg1 = generateEmbed("#cc3d32", ":ping_pong: Pong!", embed.Author, embed.Link, embed.Img, "Getting ms... Please wait...", `Generated by ${author.username}#${author.discriminator}`, author.displayAvatarURL({ dynamic: true }));
